...
class Model(nn.Module):
    ...
    def __init__(self, channel_amp = 1, channel_phase=2):
        ...
        self.SA_time_1 = Axial_Layer(16, kernel_size=128, height_dim=True)
        self.SA_time_2 = Axial_Layer(32, kernel_size=63, height_dim=True)
        self.SA_time_3 = Axial_Layer(64, kernel_size=31, height_dim=True)
        self.SA_time_4 = Axial_Layer(128, kernel_size=15, height_dim=True)
        self.SA_time_5 = Axial_Layer(256, kernel_size=7, height_dim=True)

        self.SA_frequency_1 = Axial_Layer(16, kernel_size=251, height_dim = False)
        self.SA_frequency_2 = Axial_Layer(32, kernel_size=251, height_dim = False)
        self.SA_frequency_3 = Axial_Layer(64, kernel_size=251, height_dim = False)
        self.SA_frequency_4 = Axial_Layer(128, kernel_size=251, height_dim = False)
        self.SA_frequency_5 = Axial_Layer(256, kernel_size=251, height_dim = False)

        self.ffn_1 = FeedForwardNetwork(16)
        self.ffn_2 = FeedForwardNetwork(32)
        self.ffn_3 = FeedForwardNetwork(64)
        self.ffn_4 = FeedForwardNetwork(128)
        self.ffn_5 = FeedForwardNetwork(256)		

        self.norm_1 = nn.LayerNorm([128, 251])
        self.norm_2 = nn.LayerNorm([63, 251])
        self.norm_3 = nn.LayerNorm([31, 251])
        self.norm_4 = nn.LayerNorm([15, 251])
        self.norm_5 = nn.LayerNorm([7, 251])
        #Decoder

        self.CA_time_1 = Axial_Layer_cross(256, kernel_size=7, height_dim=True)
        ...
        self.tran_conv_block_2 = NonCausalTransConvBlock(128, 64)
        self.tran_conv_block_3 = NonCausalTransConvBlock(64, 32)
        self.tran_conv_block_4 = NonCausalTransConvBlock(32, 16, output_padding=(1, 0))
        self.tran_conv_block_5 = NonCausalTransConvBlock(16, 1, is_last=True)
    def forward(self, x):
        ...
        e1 = self.norm_1(e1)
        e1_1 = self.SA_time_1(e1)
        e1_2 = self.SA_frequency_1(e1)
        e11 = e1_1 + e1_2 + e1
        e1 = self.norm_1(e11)
        e1 = self.ffn_1(e1) + e11

        e2 = self.conv_block_2(e1)
        e2 = self.norm_2(e2)
        e2_1 = self.SA_time_2(e2)
        #e2_2 = self.SA_frequency_2(e2)
        e21 = e2_1 + e2_2 + e2
        e2 = self.norm_2(e21)
        e2 = self.ffn_2(e2) + e21

        e3 = self.conv_block_3(e2)
        e3 = self.norm_3(e3)
        e3_1 = self.SA_time_3(e3)
        #e3_2 = self.SA_frequency_3(e3)
        e31 = e3_1 + e3_2 + e3
        e3 = self.norm_3(e31)
        e3 = self.ffn_3(e3) + e31	

        e4 = self.conv_block_4(e3)
        e4 = self.norm_4(e4)
        e4_1 = self.SA_time_4(e4)
        e4_2 = self.SA_frequency_4(e4)
        e41 = e4_1 + e4_2 + e4
        e4 = self.norm_4(e41)
        e4 = self.ffn_4(e4) + e41	

        # Bottle Neck
        e5 = self.conv_block_5(e4)
        e5 = self.norm_5(e5)
        e5_1 = self.SA_time_5(e5)
        e5_2 = self.SA_frequency_5(e5)
        e51 = e5_1 + e5_2 + e5
        e5 = self.norm_5(e51)
        e5 = self.ffn_5(e5) + e51

        # Decoder

        d1 = self.tran_conv_block_1(e5)
        d1 = self.norm_4(d1)
        d1_1 = self.CA_time_2(e4, d1)	
        d1_2 = self.CA_frequency_2(e4, d1)
        d11 = d1_1 + d1_2 + d1 
        d1 = self.norm_4(d11)
        d1 = self.ffn_4(d1) + d11

        d2 = self.tran_conv_block_2(d1)
        d2 = self.norm_3(d2)
        d2_1 = self.CA_time_3(e3, d2)	
        d2_2 = self.CA_frequency_3(e3, d2)
        d21 = d2_1 + d2_2 + d2 
        d2 = self.norm_3(d21)
        d2 = self.ffn_3(d2) + d21		
		
        d3 = self.tran_conv_block_3(e3)
        d3 = self.norm_2(d3)
        d3_1 = self.CA_time_4(e2, d3)	
        d3_2 = self.CA_frequency_4(e2, d3)
        d31 = d3_1 + d3_2 + d3 
        d3 = self.norm_2(d31)
        d3 = self.ffn_2(d3) + d31
		
        d4 = self.tran_conv_block_4(d3)
        d4 = self.norm_1(d4)
        d4_1 = self.CA_time_5(e1, d4)	
        d4_2 = self.CA_frequency_5(e1, d4)
        d41 = d4_1 + d4_2 + d4 
        d4 = self.norm_1(d41)
        d4 = self.ffn_1(d4) + d41

        d = self.tran_conv_block_5(d4)
